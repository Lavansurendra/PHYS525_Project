...
L = 1.33          # parallel connection length (chosen values: [1.02, 1.14, 1.33, 1.51, 3.33])
...
n_steps = 660000  # total number of time steps to simulate (chosen values: {3.33: [12000, 19000, 27000, 37000, 49000, 62000], })
